...
To analyze the whole dataset, you will need to use output files from FragPipe for all sample files (i.e., 5x72 raw files). That file can be downloaded [here](https://github.com/hds-sandbox/proteomics-sandbox/blob/webpage/TeachingModule/combined_protein.tsv).
